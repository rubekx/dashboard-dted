  ...
  return (
    <>
      ...
      <div className="min-h-full">
        <Disclosure as="nav" className="bg-dted-red">
          {({ open }) => (
            <>
        ...
        <main>
          <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <div className="px-4 py-6 sm:px-0">
                <div className="border-1 border border-gray-200 rounded-lg h-96  shadow">
                    <HomeBanner className="h-3/5 fill-current"/>
